...
package test_definitivo.lectura_mysql_db_0_1;
...
public class lectura_MySQL_DB implements TalendJob {
	...
	private final String projectName = "TEST_DEFINITIVO";
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_TEST_DEFINITIVO_lectura_MySQL_DB = new byte[0];
		static byte[] commonByteArray_TEST_DEFINITIVO_lectura_MySQL_DB = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TEST_DEFINITIVO_lectura_MySQL_DB.length) {
					if (length < 1024 && commonByteArray_TEST_DEFINITIVO_lectura_MySQL_DB.length == 0) {
						commonByteArray_TEST_DEFINITIVO_lectura_MySQL_DB = new byte[1024];
					} else {
						commonByteArray_TEST_DEFINITIVO_lectura_MySQL_DB = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TEST_DEFINITIVO_lectura_MySQL_DB, 0, length);
				strReturn = new String(commonByteArray_TEST_DEFINITIVO_lectura_MySQL_DB, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_DEFINITIVO_lectura_MySQL_DB) {
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = lectura_MySQL_DB.class.getClassLoader()
					.getResourceAsStream("test_definitivo/lectura_mysql_db_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 58624 characters generated by Talend Open Studio for Data Integration on the
 * 19 de septiembre de 2019 16:55:57 CEST
 ************************************************************************************************/