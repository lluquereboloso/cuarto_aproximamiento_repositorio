...
package prueba_importacion_git.primer_job_0_1;
...
public class primer_job implements TalendJob {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = primer_job.class.getClassLoader().getResourceAsStream(
					"prueba_importacion_git/primer_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 24884 characters generated by Talend Open Studio for Data Integration on the
 * 18 de septiembre de 2019 16:28:00 CEST
 ************************************************************************************************/